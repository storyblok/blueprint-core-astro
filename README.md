...
The blueprint is ideal for kickstarting new Storyblok and Astro projects. What's inside:
...
<!--To learn how to take advantage of Storyblok's range of features, including rich text rendering, global content management, and Internationalization, read our [Astro-Storyblok integration guide](LINK).-->
...
- To learn more about React, check the [official documentation](https://docs.astro.build).
